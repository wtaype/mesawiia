...
object WiText {
    ...
    val body  @Composable get() = TextStyle(fontFamily = fPoppins, fontWeight = FontWeight.Normal,   fontSize = FzSmart.fz_m)
    val small @Composable get() = TextStyle(fontFamily = fPoppins, fontWeight = FontWeight.Normal,   fontSize = FzSmart.fz_s3)
    val tiny  @Composable get() = TextStyle(fontFamily = fPoppins, fontWeight = FontWeight.Normal,   fontSize = FzSmart.fz_s1)
    val label @Composable get() = TextStyle(fontFamily = fPoppins, fontWeight = FontWeight.Medium,   fontSize = FzSmart.fz_s2)
}
